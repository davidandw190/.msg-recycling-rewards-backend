...
public class UserQuery {
    ...
    public static final String UPDATE_USER_DETAILS_QUERY = "UPDATE " + DB_NAME + ".users SET first_name = :firstName, last_name = :lastName, email = :email, city = :city, phone = :phone, address = :address, title = :title, bio = :bio WHERE user_id = :user_id";
